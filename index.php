  ...
  <div class="container">
    <div class="row align-items-center justify-content-between">
      ...
      <div class="col-12 col-lg-10">
        <div class="main-navigation d-lg-flex align-items-center justify-content-between" id="mainNav">
          ...
          <div class="header-right d-flex align-items-center gap-3 mt-3 mt-lg-0">
            <!-- Suchfunktion -->
            <form action="#" class="header-search-form for-des d-none d-lg-block">
